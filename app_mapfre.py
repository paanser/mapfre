...
precio_total_general = round(precio_vidrio + precio_canto, 2)

st.markdown(f"**Precio del vidrio:** {precio_vidrio:.2f} €")
if precio_canto > 0:
    st.markdown(f"**Precio del canto pulido:** {precio_canto:.2f} €")
st.markdown(f"### **TOTAL PRESUPUESTO: {precio_total_general:.2f} €**")
